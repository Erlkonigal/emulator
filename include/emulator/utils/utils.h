...
inline bool isEmpty(const std::string &text) { return text.empty(); }
...
inline bool requireArgValue(int argc, char **argv, int *index,
                            const char *option, std::string *out,
                            std::string *error) {
...
inline bool parseU32Arg(const char *option, const std::string &text,
...
inline bool parseU64Arg(const char *option, const std::string &text,
